...
describe("Protocol", function () {
    ...
    it("must expose parsingErrorCode enum from the root", function () {
        ...
        expect(minify.parsingErrorCode.unclosedMLC).toBe(1);
        expect(minify.parsingErrorCode.unclosedText).toBe(2);
        expect(minify.parsingErrorCode.unclosedQI).toBe(3);
        expect(minify.parsingErrorCode.multiLineQI).toBe(4);
    });
